...
import com.example.rafa.hibernatekeep.gestion.GestorUsuario;
...
public class Login extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    private String destino = "http://192.168.56.1:8080/Keep/go?tabla=usuario&op=login&login=pepe&pass=pepe&origen=android&accion=";
    ...
    private void abrirActividad(Usuario usuario){
